...
public class ModelCustomModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition pravayanoga = partdefinition.addOrReplaceChild("pravayanoga", CubeListBuilder.create()
				.texOffs(0, 32).addBox(3.0F, 0.0F, -1.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition levayanoga = partdefinition.addOrReplaceChild("levayanoga", CubeListBuilder.create()
				.texOffs(24, 16).addBox(-5.0F, -12.0F, -1.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition levayaruka = partdefinition.addOrReplaceChild("levayaruka",
				CubeListBuilder.create().texOffs(32, 0)
						.addBox(-9.0F, -24.0F, -1.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 32)
						.addBox(-10.0F, -17.0F, -1.0F, 1.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 24)
						.addBox(-11.0F, -15.0F, 2.0F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(32, 41)
						.addBox(-11.0F, -15.0F, 1.0F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(34, 41)
						.addBox(-11.0F, -15.0F, 0.0F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(32, 15)
						.addBox(-10.0F, -10.0F, 0.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(34, 15)
						.addBox(-10.0F, -10.0F, 1.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(36, 15)
						.addBox(-10.0F, -10.0F, 2.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition pravayaruka = partdefinition.addOrReplaceChild("pravayaruka",
				CubeListBuilder.create().texOffs(16, 32)
						.addBox(-9.0F, -24.0F, -1.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(40, 15)
						.addBox(-10.0F, -17.0F, -1.0F, 1.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(36, 41)
						.addBox(-11.0F, -15.0F, 2.0F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(38, 41)
						.addBox(-11.0F, -15.0F, 1.0F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(40, 41)
						.addBox(-11.0F, -15.0F, 0.0F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(38, 15)
						.addBox(-10.0F, -10.0F, 0.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(40, 29)
						.addBox(-10.0F, -10.0F, 1.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(40, 30)
						.addBox(-10.0F, -10.0F, 2.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
