...
@Mod("exodium")
public class ExodiumMod {
	public static final Logger LOGGER = LogManager.getLogger(ExodiumMod.class);
	public static final String MODID = "exodium";
	...
	public ExodiumMod() {
		...
		ExodiumModFluidTypes.REGISTRY.register(bus);
