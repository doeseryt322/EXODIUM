...
import net.mcreator.exodium.fluid.BloodFluid;
import net.mcreator.exodium.ExodiumMod;

public class ExodiumModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(ForgeRegistries.FLUIDS, ExodiumMod.MODID);
